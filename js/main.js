   ...
   var e = "undefined" == typeof document ? { body: {}, addEventListener: function addEventListener() {}, removeEventListener: function removeEventListener() {}, activeElement: { blur: function blur() {}, nodeName: "" }, querySelector: function querySelector() {
      ...
      for (var t = [], i = 0; i < e.length; i += 1) {
         ...
         for (var e = [], t = arguments.length; t--;) {
            e[t] = arguments[t];
             ...
             a,
             r = this;for (i = 0; i < e.length; i += 1) {
            var n = s(e[i]);for (a = 0; a < n.length; a += 1) {
      ...
      for (var t = [], i = arguments.length - 1; i-- > 0;) {
         ...
         if (void 0 === e) {
            var t = this.rtlTranslate ? -1 : 1;e = this && this.translate && this.translate * t || 0;
             ...
             o = this.isEnd,
             l = r,
             d = o;0 === s ? (a = 0, r = !0, o = !0) : (r = (a = (e - this.minTranslate()) / s) <= 0, o = a >= 1), n.extend(this, { progress: a, isBeginning: r, isEnd: o }), (i.watchSlidesProgress || i.watchSlidesVisibility || i.centeredSlides && i.autoHeight) && this.updateSlidesProgress(e), r && !l && this.emit("reachBeginning toEdge"), o && !d && this.emit("reachEnd toEdge"), (l && !r || d && !o) && this.emit("fromEdge"), this.emit("progress", a);
         ...
         var t,
            ...
            var u = parseInt(this.slides.eq(h).attr("data-swiper-slide-index") || h, 10);n.extend(this, { snapIndex: t, realIndex: u, previousIndex: o, activeIndex: h }), this.emit("activeIndexChange"), this.emit("snapIndexChange"), l !== u && this.emit("realIndexChange"), (this.initialized || this.params.runCallbacksOnInit) && this.emit("slideChange");
      ...
      var t = this,
         ...
         for (var k = 0, $ = t.slidesSizesGrid[0], L = 0; L < l.length; L += L < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup) {
            var I = L < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;void 0 !== l[L + I] ? p >= l[L] && p < l[L + I] && (k = L, $ = l[L + I] - l[L]) : p >= l[L] && (k = L, $ = l[l.length - 1] - l[l.length - 2]);
         }var D = (p - l[k]) / $,
      ...
      function t() {
       ...
       te = { name: "keyboard", params: { keyboard: { enabled: !1, onlyInViewport: !0 } }, create: function create() {
         ...
         var t = e,
             i = this,
             a = i.params.mousewheel;i.params.cssMode && t.preventDefault();var r = i.$el;if ("container" !== i.params.mousewheel.eventsTarged && (r = s(i.params.mousewheel.eventsTarged)), !i.mouseEntered && !r[0].contains(t.target) && !a.releaseOnEdges) return !0;t.originalEvent && (t = t.originalEvent);var o = 0,
             l = i.rtlTranslate ? -1 : 1,
             d = ie.normalize(t);if (a.forceToAxis) {
            if (i.isHorizontal()) {
               if (!(Math.abs(d.pixelX) > Math.abs(d.pixelY))) return !0;o = d.pixelX * l;
            } else {
               if (!(Math.abs(d.pixelY) > Math.abs(d.pixelX))) return !0;o = d.pixelY;
            }
            ...
            var h = { time: n.now(), delta: Math.abs(o), direction: Math.sign(o) },
               ...
               i.mousewheel.lastEventBeforeSnap = void 0, i.params.loop && i.loopFix();var u = i.getTranslate() + o * a.sensitivity,
                  ...
                  clearTimeout(i.mousewheel.timeout), i.mousewheel.timeout = void 0;var m = i.mousewheel.recentWheelEvents;m.length >= 15 && m.shift();var g = m.length ? m[m.length - 1] : void 0,
                     ...
                     var w = o > 0 ? .8 : .2;i.mousewheel.lastEventBeforeSnap = h, m.splice(0), i.mousewheel.timeout = n.nextTick(function () {
            ...
            var y = { time: n.now(), delta: Math.abs(o), direction: Math.sign(o), raw: e },
                x = i.mousewheel.recentWheelEvents;x.length >= 2 && x.shift();var T = x.length ? x[x.length - 1] : void 0;if (x.push(y), T ? (y.direction !== T.direction || y.delta > T.delta) && i.mousewheel.animateSlider(y) : i.mousewheel.animateSlider(y), i.mousewheel.releaseScroll(y)) return !0;
       ...
       oe = { getDistanceBetweenTouches: function getDistanceBetweenTouches(e) {
         ...
         var e = this.zoom;if (!e.enabled) {
            e.enabled = !0;var t = !("touchstart" !== this.touchEvents.start || !o.passiveListener || !this.params.passiveListeners) && { passive: !0, capture: !1 },
                ...
                s = "." + this.params.slideClass;o.gestures ? (this.$wrapperEl.on("gesturestart", s, e.onGestureStart, t), this.$wrapperEl.on("gesturechange", s, e.onGestureChange, t), this.$wrapperEl.on("gestureend", s, e.onGestureEnd, t)) : "touchstart" === this.touchEvents.start && (this.$wrapperEl.on(this.touchEvents.start, s, e.onGestureStart, t), this.$wrapperEl.on(this.touchEvents.move, s, e.onGestureChange, i), this.$wrapperEl.on(this.touchEvents.end, s, e.onGestureEnd, t), this.touchEvents.cancel && this.$wrapperEl.on(this.touchEvents.cancel, s, e.onGestureEnd, t)), this.$wrapperEl.on(this.touchEvents.move, "." + this.params.zoom.containerClass, e.onTouchMove, i);
         }
      }, disable: function disable() {
         var e = this.zoom;if (e.enabled) {
            this.zoom.enabled = !1;var t = !("touchstart" !== this.touchEvents.start || !o.passiveListener || !this.params.passiveListeners) && { passive: !0, capture: !1 },
                i = !o.passiveListener || { passive: !1, capture: !0 },
                s = "." + this.params.slideClass;o.gestures ? (this.$wrapperEl.off("gesturestart", s, e.onGestureStart, t), this.$wrapperEl.off("gesturechange", s, e.onGestureChange, t), this.$wrapperEl.off("gestureend", s, e.onGestureEnd, t)) : "touchstart" === this.touchEvents.start && (this.$wrapperEl.off(this.touchEvents.start, s, e.onGestureStart, t), this.$wrapperEl.off(this.touchEvents.move, s, e.onGestureChange, i), this.$wrapperEl.off(this.touchEvents.end, s, e.onGestureEnd, t), this.touchEvents.cancel && this.$wrapperEl.off(this.touchEvents.cancel, s, e.onGestureEnd, t)), this.$wrapperEl.off(this.touchEvents.move, "." + this.params.zoom.containerClass, e.onTouchMove, i);
         }
      } },
       ...
       ge = { setTranslate: function setTranslate() {
         for (var e = this.width, t = this.height, i = this.slides, a = this.$wrapperEl, r = this.slidesSizesGrid, n = this.params.coverflowEffect, l = this.isHorizontal(), d = this.translate, h = l ? e / 2 - d : t / 2 - d, p = l ? n.rotate : -n.rotate, c = n.depth, u = 0, v = i.length; u < v; u += 1) {
            var f = i.eq(u),
                ...
                E = l ? x * g : 0;Math.abs(E) < .001 && (E = 0), Math.abs(T) < .001 && (T = 0), Math.abs(y) < .001 && (y = 0), Math.abs(b) < .001 && (b = 0), Math.abs(w) < .001 && (w = 0);var S = "translate3d(" + E + "px," + T + "px," + y + "px)  rotateX(" + w + "deg) rotateY(" + b + "deg)";if (f.transform(S), f[0].style.zIndex = 1 - Math.abs(Math.round(g)), n.slideShadows) {
               var C = l ? f.find(".swiper-slide-shadow-left") : f.find(".swiper-slide-shadow-top"),
                   M = l ? f.find(".swiper-slide-shadow-right") : f.find(".swiper-slide-shadow-bottom");0 === C.length && (C = s('<div class="swiper-slide-shadow-' + (l ? "left" : "top") + '"></div>'), f.append(C)), 0 === M.length && (M = s('<div class="swiper-slide-shadow-' + (l ? "right" : "bottom") + '"></div>'), f.append(M)), C.length && (C[0].style.opacity = g > 0 ? g : 0), M.length && (M[0].style.opacity = -g > 0 ? -g : 0);
            }
...
document.addEventListener('DOMContentLoaded', function () {
   var productItem = document.querySelectorAll('.cabinets-slider__item'),
   ...
   if (cabinetsSlider) {
      ...
      cabinetsSlider.forEach(function (el) {
...
var selectModule = {
   ...
   getSelectClass: function getSelectClass(className) {
      return "." + className;
   },

   // Геттер элементов псевдоселекта
   getSelectElement: function getSelectElement(selectItem, className) {
      return {
   ...
   selectsInit: function selectsInit(selectItems) {
   ...
   selectInit: function selectInit(originalSelect) {
      // Создаем оболочку
      ...
      if (selectModule.getSelectPlaceholder(originalSelect)) {
         ...
         if (selectModule.getSelectPlaceholder(originalSelect).label.show) {
            var selectItemTitle = selectModule.getSelectElement(selectItem, selectModule.selectClasses.classSelectTitle).selectElement;
   ...
   selectBuild: function selectBuild(originalSelect) {
         ...
         if (targetType === 'click') {
            if (!originalSelect.disabled) {
               if (targetElement.closest(selectModule.getSelectClass(selectModule.selectClasses.classSelectTag))) {
                  ...
                  var targetTag = targetElement.closest(selectModule.getSelectClass(selectModule.selectClasses.classSelectTag));
                  var optionItem = document.querySelector("." + selectModule.selectClasses.classSelect + "[data-id=\"" + targetTag.dataset.selectId + "\"] .select__option[data-value=\"" + targetTag.dataset.value + "\"]");
                  ...
                  var _optionItem = targetElement.closest(selectModule.getSelectClass(selectModule.selectClasses.classSelectOption));
                  selectModule.optionAction(selectItem, originalSelect, _optionItem);
               }
            }
   ...
   selectsСlose: function selectsLose() {
      var selectActiveItems = document.querySelectorAll("" + selectModule.getSelectClass(selectModule.selectClasses.classSelect) + selectModule.getSelectClass(selectModule.selectClasses.classSelectOpen));
   ...
   selectAction: function selectAction(selectItem) {
      var originalSelect = selectModule.getSelectElement(selectItem).originalSelect;
      var selectOptions = selectModule.getSelectElement(selectItem, selectModule.selectClasses.classSelectOptions).selectElement;
   ...
   // Сеттер значения заголовка селекта
   setSelectTitleValue: function setSelectTitleValue(selectItem, originalSelect) {
      var selectItemBody = selectModule.getSelectElement(selectItem, selectModule.selectClasses.classSelectBody).selectElement;
      var selectItemTitle = selectModule.getSelectElement(selectItem, selectModule.selectClasses.classSelectTitle).selectElement;
   ...
   getSelectTitleValue: function getSelectTitleValue(selectItem, originalSelect) {
      // Получаем выбранные текстовые значения
      var selectTitleValue = selectModule.getSelectedOptionsData(originalSelect, 2).html;
      // Обработка значений мультивыбора
      // Если включен режим тегов (указана настройка data-tags)
      if (originalSelect.multiple && originalSelect.hasAttribute('data-tags')) {
         selectTitleValue = selectModule.getSelectedOptionsData(originalSelect).elements.map(function (option) {
            return "<span role=\"button\" data-select-id=\"" + selectItem.dataset.id + "\" data-value=\"" + option.value + "\" class=\"_select-tag\">" + selectModule.getSelectElementContent(option) + "</span>";
         }).join('');
      ...
      if (originalSelect.hasAttribute('data-search')) {
         ...
         var customClass = selectModule.getSelectedOptionsData(originalSelect).elements.length && selectModule.getSelectedOptionsData(originalSelect).elements[0].dataset.class ? " " + selectModule.getSelectedOptionsData(originalSelect).elements[0].dataset.class : '';
   ...
   getSelectElementContent: function getSelectElementContent(selectOption) {
      // Если для элемента указан вывод картинки или текста, перестраиваем конструкцию
      var selectOptionData = selectOption.dataset.asset ? "" + selectOption.dataset.asset : '';
      var selectOptionDataHTML = selectOptionData.indexOf('img') >= 0 ? "<img src=\"" + selectOptionData + "\" alt=\"\">" : selectOptionData;
   ...
   getSelectPlaceholder: function getSelectPlaceholder(originalSelect) {
   ...
   getSelectedOptionsData: function getSelectedOptionsData(originalSelect, type) {
      ...
      return {
         ...
         html: selectedOptions.map(function (option) {
            return selectModule.getSelectElementContent(option);
         })
      };
   },

   // Конструктор элементов списка
   getOptions: function getOptions(originalSelect) {
      // Настрока скролла элементов
      var selectOptionsScroll = originalSelect.hasAttribute('data-scroll') ? "data-simplebar" : '';
      var selectOptionsScrollHeight = originalSelect.dataset.scroll ? "style=\"max-height:" + originalSelect.dataset.scroll + "px\"" : '';
   ...
   getOption: function getOption(selectOption, originalSelect) {
      // Если элемент выбран и включен режим мультивыбора, добавляем класс
      var selectOptionSelected = selectOption.selected && originalSelect.multiple ? " " + selectModule.selectClasses.classSelectOptionSelected : '';
      // Если элемент выбрани нет настройки data-show-selected, скрываем элемент
      var selectOptionHide = selectOption.selected && !originalSelect.hasAttribute('data-show-selected') ? "hidden" : "";
      // Если для элемента указан класс добавляем
      var selectOptionClass = selectOption.dataset.class ? " " + selectOption.dataset.class : '';
   ...
   // Сеттер элементов списка (options)
   setOptions: function setOptions(selectItem, originalSelect) {
      // Получаем объект тела псевдоселекта
      var selectItemOptions = selectModule.getSelectElement(selectItem, selectModule.selectClasses.classSelectOptions).selectElement;
   ...
   optionAction: function optionAction(selectItem, originalSelect, optionItem) {
      if (originalSelect.multiple) {
         // Если мультивыбор
         // Выделяем классом элемент
         optionItem.classList.toggle(selectModule.selectClasses.classSelectOptionSelected);
         // Очищаем выбранные элементы 
         var originalSelectSelectedItems = selectModule.getSelectedOptionsData(originalSelect).elements;
         originalSelectSelectedItems.forEach(function (originalSelectSelectedItem) {
            originalSelectSelectedItem.removeAttribute('selected');
         });
         // Выбираем элементы 
         var selectSelectedItems = selectItem.querySelectorAll(selectModule.getSelectClass(selectModule.selectClasses.classSelectOptionSelected));
   ...
   setSelectChange: function setSelectChange(originalSelect) {
      var selectItem = originalSelect.parentElement;
   ...
   // Обработчик disabled
   selectDisabled: function selectDisabled(selectItem, originalSelect) {
      if (originalSelect.disabled) {
   ...
   searchActions: function searchActions(selectItem) {
      var originalSelect = selectModule.getSelectElement(selectItem).originalSelect;
      var selectInput = selectModule.getSelectElement(selectItem, selectModule.selectClasses.classSelectInput).selectElement;
      var selectOptions = selectModule.getSelectElement(selectItem, selectModule.selectClasses.classSelectOptions).selectElement;
      var selectOptionsItems = selectOptions.querySelectorAll("." + selectModule.selectClasses.classSelectOption);
   ...
   // Коллбэк функция
   selectCallback: function selectCallback(selectItem, originalSelect) {}
};
